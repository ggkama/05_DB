...
SELECT * FROM DEPT_COPY2 ; -- D0 NULL L2 삽입
...
-- V_DCOPY2에 다시 INSERT 수행
INSERT INTO V_DCOPY2 
VALUES('A1','마케팅1팀');
-- NULL을 
-- ("KH08_KTY"."DEPT_COPY2"."LOCATION_ID") 안에 삽입할 수 없습니다.
...
NOMINVALUE     -- 최소값 X(CYCLE과 관련된 속성)
NOCYCLE        -- 순환 X
...
-- TB_TEST 테이블에 INSERT시 PK컬럼 값을
-- 시퀀스로 얻어와서 삽입
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO.NEXTVAL, '장구'); -- 125
...
/* 인덱스를 이용하지 않고 조회하기
 * - TEST_ID 컬럼값이 'TEST500,000'인 행 조회
 */ 
SELECT * FROM TB_IDX_TEST
