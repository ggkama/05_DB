...
CREATE USER TEST08_USER IDENTIFIED BY "TEST1234";

-- ORA-01045 : 사용자 TEST08_USER는
 ...
 * - GRANT 권한,... TO 사용자명
 */
GRANT CREATE SESSION TO TEST08_USER;
--> 연결 확인됨
...
/* TEST08_USER에게 테이블 생성 공간 할당 
 * - USERS폴더 내에 10M 할당
 */
ALTER USER TEST08_USER
DEFAULT TABLESPACE USERS 
QUOTA 10M ON USERS;


/* 다시 TEST08_USER 계정 접속*/
CREATE TABLE TEST_TABLE(
	TEST_NO NUMBER PRIMARY KEY,
	TEST_COL VARCHAR2(30) NOT NULL
);
