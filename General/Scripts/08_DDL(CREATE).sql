 ...
 * 비밀번호	    : MEMBER_PW  	 VARCHAR(20)
 * 이름 			: MEMBER_NAME    VARCHAR(15) (한글 5글자)
...
INSERT INTO "MEMBER" 
VALUES('MEM03','ASDF1234','박철수', '970108-1456789',DEFAULT);
--> ENROLL_DATE칼럼에 설정된 DEFAULT 값(SYSDATE) 삽입

-- 가입일 -> INSERT 시 미작성 하는 경우 -> DEAFULT 값이 반영됨
INSERT INTO "MEMBER"(MEMBER_ID,MEMBER_PW,MEMBER_NAME,MEMBER_SSN) 
VALUES('MEM04','ZXCV0000','신짱구', '960707-1987654');
 ...
 * 
 * 1) 컬럼레벨 설정 : 테이블 컬럼을 선언할 때 제약조건을 추가
 *  [작성법]
...
CREATE TABLE USER_USED_NN(
    -- USER_NO NUMBER NOT NULL, -- 제약조건명 미지정시 "SYS~"형태로 자동 지정
   USER_NO NUMBER CONSTRAINT USER_NO_NN NOT NULL, -- 제약조건명 지정한 상태 
    USER_ID VARCHAR2(20) ,
...
--> 50이라는 값은 USER_GRADE 테이블 GRADE_CODE 컬럼에서 제공하는 값이 아니므로
 ...
 -- 무결성 제약조건(KH08_KTY.GRADE_CODE_FK1)이 위배되었습니다
 -- - 부모 키가 없습니다
...
CREATE TABLE USER_USED_FK3(
  ...
  ON DELETE CASCADE -- 부모행 삭제시 참조하는 모든 자식행 삭제
...
SELECT * FROM USER_USED_FK3; -- 10을 참조하던 1,2번 유저 삭제
...
LEFT JOIN 
	USER_GRADE PARENT 
ON
	(CHILD.GRADE_CODE=PARENT.GRADE_CODE);



----------------------------------------------------------------------------------------------------------------

/* CHECK 제역 조건은 FK의 하위 호환 */
...
INSERT INTO CHECK_TEST VALUES('장구',40);
...
CONSTRAINT NN_USER_PWD NOT NULL, --NOT NULL , UNIQUE
PNO CHAR(14)
CONSTRAINT NN_PNO NOT NULL,-- NOT NULL
GENDER VARCHAR2(3),-- CHECK
PHONE CHAR(13),
ADDRESS VARCHAR2(500),
STATUS VARCHAR2(1) CONSTRAINT NN_STATUS NOT NULL,-- NOT NULL , CHECK

-- 테이블 레벨
 CONSTRAINT PK_USER_TEST PRIMARY KEY (USER_NO),
 CONSTRAINT UK_USER_ID UNIQUE (USER_ID),
 CONSTRAINT UK_PNO UNIQUE (PNO),
 CONSTRAINT CK_GENGER CHECK(GENDER IN('남','여')), 
...
VALUES(1,'USER01','PASSO1','880122-1234567','남','010-1234-1234',NULL,'N');
INSERT INTO USER_TEST
VALUES(2,'USER02','PASSO2','980108-1248567','남','010-1553-5431',NULL,'N');
INSERT INTO USER_TEST
VALUES(3,'USER03','PASSO3','780115-1334567','여','010-5325-3214',NULL,'Y');
INSERT INTO USER_TEST
VALUES(4,'USER04','PASSO4','680822-1137867','남','010-1456-8945',NULL,'N');
INSERT INTO USER_TEST
VALUES(5,'USER05','PASSO5','580422-1469134','여','010-6871-1387',NULL,'Y');
...
--> 서브쿼리로 테이블 생성 시 
-- 별도의 제약조건 설정,DEFAULT설정,COMMENT설정이 필요하다
